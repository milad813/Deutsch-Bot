"""Data models for the German Learning Bot."""
...
@dataclass
class Word:
    """Represents a German word with its translations and metadata."""
    ...
    def display_german(self) -> str:
        """Get the German word with article if available."""
        if self.article:
    ...
    def extra_forms_line(self) -> Optional[str]:
        """Get additional grammatical forms based on word type."""
    ...
    def collocation_line(self) -> Optional[str]:
        """Get collocation information if available."""
