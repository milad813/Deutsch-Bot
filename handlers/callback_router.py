...
PREFIX_ROUTES: List[Tuple[str, Callable]] = [
    ...
    ("story_hint:", lambda q, c, s: story_handlers.show_story_hint(q, c, int(s))),
    ("story_listen_read:", lambda q, c, s: story_handlers.play_story_listen_read(q, c, int(s))),
    ("story_listen_only:", lambda q, c, s: story_handlers.play_story_listen_only(q, c, int(s))),
    ("story_replay:", lambda q, c, s: story_handlers.replay_story(q, c, int(s))),
